...
- Sem consentimento do titular apenas para cumprir obrigações legais, políticas públicas, pesquisa com anonimização, exercício de direitos, proteção da vida ou saúde, e segurança em identificação eletrônica. 
```

```ad-warning
##### Tratamento de dados pessoais de crianças ou adolescentes
Só pode ocorrer nas seguintes hipóteses:
- Com o consentimento específico e em destaque dado por pelo menos um dos pais ou pelo responsável legal;
- Sem o consentimento quando a coleta for necessária para contatar os pais ou o responsável legal, utilizados uma única vez e sem armazenamento, ou para sua proteção, e em nenhum caso podem ser repassados a terceiro sem o consentimento;
```
#### Princípios
As atividades de tratamento de dados pessoais devem seguir os seguintes princípios.

**Transparência**: garantia, aos titulares, de informações claras, precisas e de fácil acesso;
**Segurança**: Utilização de medidas técnicas e administrativas aptas a proteger os dados dos usuários;
...
- Realizado para fins exclusivamente: 
	...
	- Acadêmicos;
- Realizado para fins exclusivamente de:
	- Segurança pública;
	- Defesa nacional;
	- Segurança do Estado;
...
2. Para o cumprimento de obrigação legal ou regulatório pelo **controlador**;
...
- **Controlador**: Pessoa natural ou jurídica, de direito público ou privado, a quem competem as decisões referente ao tratamento de dados pessoais.
- **Operador**: Pesosa natural ou jurídica, de direito público ou privado, que realiza o tratamento de dados pessoais em nome do controlador;
```

```ad-info
É dispensada a exigência do consentimento do titular para os dados tornados manifestamente públicos pelo titular.
```

```ad-info
O consentimento do titular deve ser fornecido por escrito ou por outro meio que demonstre a sua manifestação de vontade. Esse consentimento pode ser revogado a qualquer momento mediante manifestação expressa do titular, por procedimento gratuito e facilitado.
```
...
3. Comunicação do titular, inclusive do exercício de seu direito de revogação do consentimento;
4. Determinação da autoridade nacional, quando houver violação da LGPD;
#### Sanções
As sanções serão aplicadas após o devido procedimento administrativo que possibilite a oportunidade de ampla defesa.

1. Advertência;
2. Multa, de até 2% do faturamento no seu último exercício, excluídos os tributos, limitada, no total, a R$ 50.000.000,00 por infração;
...
Podem ser aplicadas outras sanções após a aplicação dessas sanções:
1. Suspensão parcial do funcionamento do banco de dados a que se refere a infração pelo período máximo de 6 meses, podendo ser prorrogável;
2. Suspensão do exercício da atividade de tratamento dos dados pessoais a que se refere a infração pelo período máxima de 6 meses, podendo ser prorrogável;
3. Proibição parcial ou total do exercício de atividades relacionadas ao tratamento de dados;

```ad-summary
##### Autoridade Nacional de Proteção de Dados (ANPD)
Dotada de autonomia técnica e decisória, com patrimônio próprio. 
